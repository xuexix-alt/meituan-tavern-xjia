...
import { buildUpstreamUrl, type UpstreamResource } from './upstream.js';
...
async function forward(request: Request, response: Response, resource: UpstreamResource, fetchImpl: typeof fetch) {
...
function copyResponseHeaders(headers: Headers, response: Response): void {
